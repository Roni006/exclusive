            ...
            <div className="container border-b border-[rgba(0,0,0,0.25)]">
                ...
                <div className="grid grid-cols-4 gap-[30px] items-center justify-between">
                    ...
                    <div className="product-item">
                        ...
                        <div className="details pt-4">
                            <h2 className="text-[18px] leading-6 font-poppins text-[#000000] font-medium">AK-900 Wired Keyboard</h2>
                            <p className="text-[16px] leading-6 font-poppins font-semibold flex gap-3 py-2" >
                            ...
                            <div className="raring flex gap-1 items-center">
                                ...
                                <span className="text-[14px] leading-[21px] font-poppins font-semibold text-[rgba(0,0,0,0.5)] ">(75)</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="product-item">
                        ...
                        <div className="details pt-4">
                            <h2 className="text-[18px] leading-6 font-poppins text-[#000000] font-medium">IPS LCD Gaming Monitor</h2>
                            <p className="text-[16px] leading-6 font-poppins font-semibold flex gap-3 py-2" >
                            ...
                            <div className="raring flex gap-1">
                                ...
                                <TiStarFullOutline className="text-[#FFAD33] text-[20px] " />
                                <TiStarFullOutline className="text-[#FFAD33] text-[20px] " />
                                <span className="text-[14px] leading-[21px] font-poppins font-semibold text-[rgba(0,0,0,0.5)] ">(99)</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="product-item">
                        ...
                        <div className="details pt-4">
                            <h2 className="text-[18px] leading-6 font-poppins text-[#000000] font-medium">S-Series Comfort Chair </h2>
                            <p className="text-[16px] leading-6 font-poppins font-semibold flex gap-3 py-2" >
