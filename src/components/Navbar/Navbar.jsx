        ...
        <nav className="border-b border-[rgba(0,0,0,0.25)]">
          ...
          <div className="container">
            <div className="pt-10 pb-4 flex items-center">
              ...
              <div className={`w-[60%] ${searchBar ? "hidden" : "block"}`}>
              ...
              <div
                className={`${searchBar ? "w-[90%]" : "w-[30%]"} duration-300 flex items-center justify-end gap-6`}
              >
                <div
                  onClick={() => setSearchBar(true)}
                  className={`${searchBar ? "w-[80%] relative" : "w-[243px] "} relative`}
                >
                  <input
